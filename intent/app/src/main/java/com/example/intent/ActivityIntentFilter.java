...
si.putExtra(Intent.EXTRA_EMAIL, new String[]{"devinfrr@gmail.com"});
// Mengatur data nilai untuk Subject E-Mail
si.putExtra(Intent.EXTRA_SUBJECT, "Welcome to 3SC4 Class");
// Mengatur data nilai untuk Badan E-Mail
si.putExtra(Intent.EXTRA_TEXT, "Welcome to My Class");
